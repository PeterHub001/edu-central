...
const LandingPage = () => {
  return (
    <div className='flex bg-white'>
        ...
        <Link to="login" className='mt-14 p-3 px-6 pt-4 pb-4 text-white bg-[#6D35DE] rounded-l-xl rounded-r-xl text-center'>
            Login as an admin
        </Link>
        <Link to="login" className='p-3 mt-7 px-6 pt-4 pb-4 text-white bg-[#0539B4] rounded-l-xl rounded-r-xl text-center'>
            Login as member
        </Link>
